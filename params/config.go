...
// ================= [사용자 추가 코드 시작] =================
// 하드포크할 블록 높이 정의
const MyForkBlockNumber = 1919999

// 나의 새로운 체인 ID 정의 (예: 58051)
var MyChainID = big.NewInt(58051)
// ================= [사용자 추가 코드 끝] =================
...
var (
        ...
        MainnetChainConfig = &goethereum.ChainConfig{
                ChainID:                       big.NewInt(58051),
                SupportedProtocolVersions:     vars.DefaultProtocolVersions,
                HomesteadBlock:                big.NewInt(1_150_000),
                DAOForkBlock:                  nil,
                DAOForkSupport:                false,
                EIP150Block:                   big.NewInt(2_500_000),
                EIP155Block:                   big.NewInt(1_920_000),
                EIP158Block:                   big.NewInt(1_920_000),
                ByzantiumBlock:                big.NewInt(1_920_000),
                ConstantinopleBlock:           big.NewInt(1_920_000),
                PetersburgBlock:               big.NewInt(1_920_000),
                IstanbulBlock:                 big.NewInt(1_920_000),
                MuirGlacierBlock:              big.NewInt(1_920_000),
                BerlinBlock:                   big.NewInt(1_950_000),
                LondonBlock:                   big.NewInt(1_950_000),
                ArrowGlacierBlock:             big.NewInt(1_950_000),
                GrayGlacierBlock:              big.NewInt(1_950_000),
